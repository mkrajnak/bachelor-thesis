...
\abstract[en]{The aim of this work is to document the development process of configuration dialogs for oVirt entities. Main focus is placed on virtual machine dialog as it has plenty of dependencies related to each other. The work also describes communication with oVirt Rest API and experimentally ManageIQ Rest API. Dialogs are created using modern Javascript frameworks React, Redux and Redux-Saga to secure proper content and state management in every possible situation. This should improve the code base, user-experience and speed up execution of basic tasks.}
